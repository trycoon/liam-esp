...
// RTK baserad GPS. Här finns karta över närliggande stationer:
// http://www.epncb.oma.be/_networkdata/data_access/real_time/map.php u-blox NEO-7N, ±6-10 meter u-blox NEO-8T, ±1-6
// meter u-blox ZED-F9P, ±1 meter without RTCM, 1-2 centimeter when using RTCM signal.
//
// Information about RTK: https://gssc.esa.int/navipedia/index.php/Real_Time_Kinematics and
// //https://www.youtube.com/watch?v=n8PUyOtiGKo Useful RTK blog: http://rtkexplorer.com
...
// OBS!
// Sparkfun rekommenderar att man inte kör några pull-ups på I2C bussen då kortet redan har egna motstånd för pullups!
// Och de rekommendeerar att man kör busseen i 100KHz hastighet! Stäng också av NMEA occh UART om vi inte behöver dom,
// för att avlast kortet.
///
GNSS::GNSS(TwoWire& w)
    : _Wire(w)
{
