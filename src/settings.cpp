...
namespace Settings {
    ...
    */
    const uint8_t IO_ACCELEROMETER_ADDRESS = 0x53; // set to "0" if not available.
    ...
    */
    ...
    /*
      Bumper sensor
    */
     const uint8_t BUMPER_SENSOR_PIN = 4;  // Pin on digital port expander for detecting obstacles (bumper), set to 0 if not used.
