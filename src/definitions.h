...
namespace Definitions {
  ...
  */
  ...
  extern const uint8_t LORA_DIO0_PIN; // interrupt pin #1 ("RxDone", "TxDone", "CadDone")
  extern const uint8_t LORA_DIO1_PIN; // interrupt pin #2 ("RxTimeout", "FhssChangeChannel", "CadDetected")
