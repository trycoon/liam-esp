 ...
 * @return -1 malformated activeWeekdays, -2 malformated startTime, -3 malformated stopTime, -4 too many entries. 0 or
 * greater = success
 */
...
/**
 * Override schedule to force mower to start mowing outside of schedule, this is used when manually launching mower from
 * API.
 */
