...
//
// NOTE! If changing pin definitions, please read up on pins that could be used
// on the ESP32 (some are special):
...
// Lithium-ion / LiPo
// http://batteryuniversity.com/learn/article/types_of_lithium_ion Normally a
...
/*
  ...
  Pulling this pin LOW will wipe Flash-memory from ALL settings and reboot
  mower.
*/
...
// How many lines of log messages that are kept, increase to have longer log
// message history at the expense of higher memory consumption.
...
// If mower is in Stuck-state, how long (in seconds) should it wait before it
// tries again? Set "0" for no retries.
