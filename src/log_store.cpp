...
/**
 * Lowlevel class for writing log messages to serial output, but also to store
 * them for later retrieval with method getLogmessages.
 */
LogStore::LogStore()
    : HardwareSerial(0)
{
...
{
    logmessage_response response = { total : current_lastnr, messages : log_messages };
