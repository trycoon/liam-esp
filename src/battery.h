...
private:
    static const uint16_t MAX_SAMPLES = 100; // How much history are we going to keep? set too high will consume
    ...
    static const uint8_t CURRENT_MEDIAN_SAMPLES = 11; // How many samples should we take to calculate a median value for
                                                      // charge current. Don't fiddle with this unless needed.
