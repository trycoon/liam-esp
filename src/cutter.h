...
private:
    static const uint8_t LOAD_MEDIAN_SAMPLES = 5; // How many samples should we take to calculate a median value for
                                                  // cutter load. Don't fiddle with this unless needed.
