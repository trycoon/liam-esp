...
void Adafruit_INA219::init() {
  //_i2c->begin();  // Don't mess up with already initialized Wire-library
...
void Adafruit_INA219::setAmpAverage() {
  ...
  delay(69); // Max 12-bit 128S conversion time is 69mS per sample, but read can happen more frequently
}
