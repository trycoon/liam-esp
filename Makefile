...
.PHONY: help prepush ci firmware-ci firmware-build cppcheck clang-format-check clang-format-fix web-ci web-install web-lint web-build clean
...
firmware-ci: firmware-build cppcheck clang-format-check
